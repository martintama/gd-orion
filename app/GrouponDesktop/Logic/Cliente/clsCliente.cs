...
namespace GrouponDesktop.Logic
{
    public class clsCliente
    {
        ...
        public List<Cliente> GetClientes(String nombre, String apellido, Int32 dni, String email)
        {
            ...
            String sqlstr = "select c.idcliente, c.nombre, c.apellido, c.dni, c.email, c.telefono, c.direccion, c.localidad, c.codigo_postal, ";
            sqlstr += "Convert(char(10),c.fecha_nacimiento,102) fecha_nacimiento, u.idusuario, u.clave, c.credito_actual, c.activo, ";
            sqlstr += "cc.idciudad, ci.descripcion ciudad, u.username, u.habilitado as usuariohabilitado from ORION.clientes c  ";
